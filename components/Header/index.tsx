            ...
            <div className="mt-6 flex flex-col justify-stretch space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4">
              {about.socials.twitter && (
                ...
                >
                  ...
                  <span className="sm:block md:hidden ml-1">{`@${about.socials.twitter}`}</span>
                </a>
              )}
              {about.socials.instagram && (
                <a
                  href={`https://instagram.com/${about.socials.instagram}`}
                  className="text-gray-400 hover:text-gray-300 flex"
                >
                  <svg
                    className="h-6 w-6"
                  ...
                  <span className="sm:block md:hidden ml-1">{`@${about.socials.instagram}`}</span>
                </a>
              )}
            </div>
          </div>
